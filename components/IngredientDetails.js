...
const IngredientDetails = (props) => {
  ...
  return (
		<div>
			...
			>
				<div variant='outlined' key={props.index}>
				...
				<DialogContent sx={{ color: "black" }} className={styles.dialogBox}>
					...
					>
						<Box>
							...
							<Box className={styles.perServing}>
								<span className={styles.fatLabel}>per serving: </span>
								{props.item.suggestion[0].amount +
									props.item.suggestion[0].unit}
							</Box>
							...
							<Box className={styles.fat}>
								<span className={styles.fatLabel}>Fat:</span>{" "}
								{props.item.suggestion[0].fat} grams
							</Box>
							<Box className={styles.carbs}>
								<span className={styles.carbsLabel}>Carbohydrates:</span>{" "}
								{props.item.suggestion[0].carbs} grams
							</Box>
							<Box className={styles.protein}>
								<span className={styles.proteinLabel}>Protein:</span>{" "}
								{props.item.suggestion[0].protein} grams
							</Box>
						</Box>
					</Box>
